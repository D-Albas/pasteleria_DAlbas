...
urlpatterns = [
    ...
    path('vistaCarrito/', views.vistaCarrito, name="vistaCarrito"),
    ...
    path('registrarPedidoCliente/',views.registrarPedidoCliente, name="registrarPedidoCliente"),
    path('vistaPedidosCliente/',views.vistaPedidosCliente, name="vistaPedidosCliente"),
    ...
    path('vistaOtrosRegistros/', views.vistaOtrosRegistros, name='vistaOtrosRegistros'),
    path('registrar_categoria/', views.registrar_categoria, name='registrar_categoria'),
    path('registrar_tematica/', views.registrar_tematica, name='registrar_tematica'),
]
