...
function mostrarDatosTabla() {
    ...
    detalleSolicitudPedidos.forEach(entrada => {
        ...
        datos += "<tr>";
        datos += "<td class='text-center' style='vertical-align: middle;'><img src='" + productos[E].imagenProducto + "' alt='Imagen del producto' width='50' height='50'></td>";
        datos += "<td style='vertical-align: middle;'>" + productos[E].nombreProducto + "</td>";
        datos += "<td style='vertical-align: middle;'>" + productos[E].unidadMedidaProducto + "</td>";
 ...
 */
function cargarProductos(idProducto, nombreProducto, precioProducto, unidadMedidaProducto, imagenProducto) {
    const elemento = {
